...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('movie club', url='https://t.me/+i8Zh9joZ1ZpkMTk1')
            ],[
        ...
        for msg in msgs:
            ...
            buttons = [
                [
                    ...
                    InlineKeyboardButton('owner', url='https://t.me/howtodoyt')
                ],
                [
                    InlineKeyboardButton('Series & Movie Club', url=f'https://t.me/+i8Zh9joZ1ZpkMTk1')
                ]
                ]
            try:
